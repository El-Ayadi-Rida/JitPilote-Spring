...
INSERT INTO board (board_id, board_name, description, start_date, access_level, fav, workspace_id_board) VALUES (7, 'Product Deployment', 'Description of Product Deployment', NOW(), 'PUBLIC', false, 6);
INSERT INTO board (board_id, board_name, description, start_date, access_level, fav, workspace_id_board) VALUES (8, 'Product Dev.', 'Description of Product Development', NOW(), 'PUBLIC', false, 6);
...
INSERT INTO section (section_id, section_title, board_id_section) VALUES (7, 'TODO',8);
INSERT INTO section (section_id, section_title, board_id_section) VALUES (8, 'IN PROGRESS',8);
INSERT INTO section (section_id, section_title, board_id_section) VALUES (9, 'DONE',8);
...
INSERT INTO ticket (ticket_id, title, description, start_date, end_date, priority, section_id_ticket) VALUES (7, 'Build Home Page ', 'Description of Building home page ', NOW(), DATE('2024-12-31 01:02:03'), 'HIGH', 7);
INSERT INTO ticket (ticket_id, title, description, start_date, end_date, priority, section_id_ticket) VALUES (8, 'User Authentication', 'Description of User Authentication ', NOW(), DATE('2024-12-31 01:02:03'), 'HIGH', 7);
INSERT INTO ticket (ticket_id, title, description, start_date, end_date, priority, section_id_ticket) VALUES (9, 'Fix search bar ', 'Description of Fix search bar ', NOW(), DATE('2024-12-31 01:02:03'), 'HIGH', 7);

INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (1, 'Write unit tests', false, 1);
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (7, 'Write integration tests', false, 1);
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (8, 'Logback', false, 1);
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (9, 'Authentication JWT', false, 1);
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (10, 'API Security', false, 1);
...
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (13, 'Database Conception', false, 7);
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (14, 'UI/UX Design', false, 7);
INSERT INTO task (task_id, title, is_done, ticket_id_task) VALUES (15, 'Project Init.', false, 7);
